    ...
    return (
        <div className="flex flex-row items-center sm:mb-8 space-x-0 sm:space-x-2 justify-center">
            {data?.isPlaying ? (
                ...
                <svg className="h-4 w-4 mr-5 sm:mr-0 mt-[-2px]" viewBox="0 0 168 168">
                    <path
                        fill="#1ED760"
            ...
            <div className="inline-flex flex-col sm:flex-row max-w-full truncate">
                {data?.isPlaying ? (
                    ...
                    <p className="capsize text-gray-800 dark:text-gray-200 font-medium max-w-max truncate">
                        Not Playing
                    </p>
                )}
                ...
                <p className="capsize text-gray-500 max-w-max truncate">
                    {data?.isPlaying && data?.artist ? data?.artist : 'Spotify'}
                </p>
            </div>
        </div>
    )
